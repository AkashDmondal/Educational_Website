 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Course Resgistration </h1>
                    </div>
                </div>
                <div class="row" >
...
<div class="form-group">
    <label for="courseunit">Course Duration  </label>
    <input type="text" class="form-control" id="courseunit" name="courseduartion" placeholder="Course Duration" required />
  </div> 
