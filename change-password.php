...
{
$sql=mysql_query("SELECT password FROM  students where password='".$_POST['cpass']."' && studentRegno='".$_SESSION['login']."'");
$num=mysql_fetch_array($sql);
if($num>0)
{
 $con=mysql_query("update students set password='".$_POST['newpass']."', updationDate='$currentTime' where studentRegno='".$_SESSION['login']."'");
