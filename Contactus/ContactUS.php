...
$query=mysqli_query($con,"insert into contactinfo(name,mobileno,email,subject,course,activationcode,status) values('$name','$mobileno','$email','$subject','$course','$activationcode','$status')");
	if($query)
	{
$to=$email;
...
$headers .= 'From:RCS Technology| Programing Blog <info@rcsinfo.in>'."\r\n";
...
echo "<script>alert('Your Details Are Submitted , Thank You');</script>";
...
<div class="container-fluid">
 ...
 <!--/left-->
  ...
  <div class="col-sm-6">
    <div class="row">
      <div class="col-xs-12">
        <h3>Fill The Details We Will Conatct You Shortly </h3>
		<hr >
  ...
  <tr>
    <th height="62" scope="row">Mobile No </th>
    <td width="71%"><input type="text" name="mobileno" id="mobileno" value=""  class="form-control" required /></td>
  </tr>
  ...
  <tr>
    <th height="62" scope="row">subject </th>
    <td width="71%"><input type="text" name="subject" id="subject" value=""  class="form-control" required /></td>
  </tr>
  
  
  <tr>
    <th height="62" scope="row">Course </th>
    <td width="71%"><input type="text" name="Course" id="Course" value=""  class="form-control" required /></td>
  </tr>
