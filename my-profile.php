...
$ret=mysql_query("update students set studentName='$studentname',studentPhoto='$photo',cgpa='$cgpa',cgpa12='$cgpa12'  where StudentRegno='".$_SESSION['login']."'");
if($ret)
{
...
<div class="form-group">
    <label for="CGPA"> CGPA (X) </label>
    <input type="text" class="form-control" id="cgpa" name="cgpa"  value="<?php echo htmlentities($row['cgpa']);?>" required />
  </div>  
  <div class="form-group">
    <label for="CGPA12"> CGPA (XII)/Percentage(%)
	<input type="text" class="form-control" id="cgpa12" name="cgpa12"  value="<?php echo htmlentities($row['cgpa12']);?>" required />
  </div> 
